                        ...
                        <div class="card-header pb-0 d-flex w-100  justify-content-between">
                            ...
                            <div class="p-0">
                                <button type="button" class="btn btn-block btn-sm bg-primary mb-3 px-3 text-sm text-white"
                                            data-bs-toggle="modal" data-bs-target="#modal-holiday">Add Holiday
                                    </button>
                            </div>
                            <div class="modal fade" id="modal-holiday" tabindex="-1" role="dialog"
                                     aria-labelledby="modal-holiday" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                                        <div class="modal-content">
                                            <div class="modal-body p-0">
                                                <div class="card card-plain">
                                                    <div class="card-header pb-0 text-left">
                                                        <h4 class="font-weight-bolder text-primary">Add Holiday</h4>
                                                    </div>
                                                    <div class="card-body">
                                                        <form class="form text-left" method="POST"
                                                              action="{{route('holiday.store')}}">
                                                            @csrf
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-12 col-md-12">
                                                                    <label>Hari</label>
                                                                    <select name="choosen_day" id="" class="form-control">
                                                                        <option value="">
                                                                            <i>-- Pilih Hari --</i>
                                                                        </option>
                                                                        <option value="senin">
                                                ...
                                                <td class="p-1">
                                                    <div class="d-flex px-0 py-1">
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <h6 class="mb-0 text-sm">{{$holiday->employee->name}}</h6>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="p-1">
                                                    <p class="text-xs font-weight-bold mb-0">{{$holiday->choosen_day}}</p>
                                                </td>
                                                <td class="p-0">
